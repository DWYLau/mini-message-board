...
const DeleteForm: React.FC<DeleteFormProps> = ({
  ...
  return (
    <div className="flex flex-col justify-evenly items-center p-2 m-2 rounded-lg border-4 border-solid border-sky-800 bg-inherit  absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[300px] w-[400px] z-50">
